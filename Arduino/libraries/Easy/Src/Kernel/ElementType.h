...
#define DIGITAL_LOOPSWITCH_INDEX 5
#define DIGITAL_MONOFLOP_INDEX 6

// Indexes for EkiAnalog
#define ANALOG_INPUT_INDEX 1
#define ANALOG_JOYSTICKAXIS_INDEX 2
#define ANALOG_VARIABLEINPUTSWITCH_INDEX 3
...
#define VIRTUAL_VARIABLEINPUTSWITCH_INDEX 4
...
#define LOGIC_DEPENDENDINPUT_INDEX 2
...
#define MOTOR_STEPPERROTATEI2C_INDEX 9
