//*****************************************************************
//* Test for encoder motor controlled by L298:
//*
...
void setup()
{
  ...
  EncoderMotorL298* encoderMotor = new EncoderMotorL298(MOTOR_DIRECTIONPIN_A, MOTOR_SPEEDPIN_A, ENCA, ENCB, PPR, GEAR_RATIO, 0);
